    ...
    try:
        ...
        stream = ollama.chat(
            ...
            messages=[
                {'role': 'system', 'content':
                 """
                 You are a helpful medical assistant with tool calling capabilities. When you receive a tool call response, use the output to format an answer to the orginal use question.\n
